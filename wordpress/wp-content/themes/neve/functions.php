...
// 	global $menu;
// 	$menu[1][2] = "http://localhost/wordpress/wp-admin/admin.php?page=formidable-entries&form=1&frm_action=list&_wpnonce=c1a852555e&_wp_http_referer&paged=1";
// }
...
function wpso_custom_links_admin_menu() {
    ...
    $submenu['index.php'][] = array( 'Refill request', 'read', 'http://localhost/wordpress/wp-admin/admin.php?page=formidable-entries&form=3&frm_action=list&_wpnonce=c1a852555e&_wp_http_referer&paged=1' );

    $submenu['index.php'][] = array( 'Transfer Prescription', 'read', 'http://localhost/wordpress/wp-admin/admin.php?page=formidable-entries&form=4&frm_action=list&_wpnonce=c1a852555e&_wp_http_referer&paged=1' );
}
...
// 	global $menu;
// 	$menu[1][2] = "http://localhost/wordpress/wp-admin/admin.php?page=formidable-entries&form=3&frm_action=list&_wpnonce=c1a852555e&_wp_http_referer&paged=1";
// }
