...
define( 'WPMS_SMTP_USER', 'dhyeyrajpara072@gmail.com' ); // SMTP authentication username, only used if WPMS_SMTP_AUTH is true.
define( 'WPMS_SMTP_PASS', '856734219' ); // SMTP authentication password, only used if WPMS_SMTP_AUTH is true.
