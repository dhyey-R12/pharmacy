...
function admin_bar_item ( WP_Admin_Bar $admin_bar ) {
    ...
    $admin_bar->add_menu( array(
        ...
        'href'  => admin_url('http://localhost/wordpress/wp-admin/admin.php?page=formidable-entries&form=1&frm_action=list&_wpnonce=c1a852555e&_wp_http_referer&paged=1'),
        'meta' => [
